...
# Local project modification: create the networked client lazily. The upstream
# SkyScanner constructor performs PerimeterX network setup immediately; doing
# that during MCP startup can close the stdio connection before Claude finishes
# the MCP handshake.
scanner = None
