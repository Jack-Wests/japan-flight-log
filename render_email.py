...
RUN = {
    "date_iso": "2026-08-24",
    "date_human": "Mon 24 Aug 2026",
    "verdict_headline": "🔴 HOLD — nothing moved today",
    "best_pp": "$1,496",
    "best_all4": "$5,984",
    "target_distance": "$496 above",
    "snapshot": [
        "The cheapest way to get all four of you to the Hokkaido snow and home again is "
        "<b>$1,496 per person — $5,984 for the four</b>. That's Air Niugini Brisbane→Tokyo "
        "and back through Port Moresby, with both Sapporo hops folded in.",
        "Nothing moved: that's <b>$1pp cheaper than yesterday</b> ($1,497) and $75 above where "
        "it sat a week ago. Across 34 checks the cheapest has run between <b>$1,333 and "
        "$1,688</b>, so today is mid-pack — no reason to jump.",
        "The catch on the cheap one hasn't changed either: a 20-hour overnight stuck in Port "
        "Moresby with nothing to leave the airport for, which makes it about <b>41 hours from "
        "Brisbane to the snow</b>. $206pp more buys you out of it entirely — that's the "
        "best-value row, and it's the one worth watching.",
        "No airline sale could be verified today — the Jetstar, Qantas and Virgin deal pages "
        "were all blocked, so nothing is confirmed live. Nothing to do but wait.",
    ],
    "options": [
        # (label, getting there, getting home, pp, all4, worth knowing)
        ("Cheapest",
         "🛫 Dep Brisbane (BNE) Tue 2 Feb 2:40pm → 🛬 lands Tokyo (NRT) Wed 3 Feb 8:00pm "
         "<i>(Air Niugini via Port Moresby)</i>, night near Narita, then 🛫 Thu 4 Feb 7:15am "
         "→ 🛬 Sapporo (CTS) 9:05am",
         "🛫 Dep Tokyo (NRT) Wed 17 Feb 9:40pm → 🛬 lands Brisbane (BNE) Thu 18 Feb 9:40am "
         "<i>(Air Niugini via Port Moresby)</i>",
         "$1,496", "$5,984",
         "Long haul: 30h to Tokyo, ~41h to the snow — a 20h overnight stuck in Port Moresby "
         "you can't leave. Brutal. The 11h flight home is the best bit"),
        ("Best value",
         "🛫 Dep Brisbane (BNE) Tue 2 Feb 6:10pm → 🛬 lands Sapporo (CTS) Wed 3 Feb 3:50pm "
         "<i>(Singapore Airlines via Singapore, then a 5h daylight stop in Osaka)</i>",
         "🛫 Dep Tokyo (NRT) Wed 17 Feb 9:40pm → 🛬 lands Brisbane (BNE) Thu 18 Feb 9:40am "
         "<i>(Air Niugini via Port Moresby)</i>",
         "$1,702", "$6,808",
         "22h40m there · 11h home. Proper airline seats the whole way, no airport floor, "
         "lands 3:50pm. $206pp to cut 18 hours off the trip over"),
        ("Fastest sensible",
         "🛫 Dep Brisbane (BNE) Mon 1 Feb 11:45am → 🛬 lands Sapporo (CTS) Tue 2 Feb 9:15am "
         "<i>(Jetstar nonstop to Osaka, night in a bed near Kansai, 7:20am flight up)</i>",
         "🛫 Dep Tokyo (NRT) Mon 15 Feb 8:55pm → 🛬 lands Brisbane (BNE) Tue 16 Feb 6:50am "
         "<i>(Jetstar nonstop)</i>",
         "$1,846", "$7,384",
         "22h30m there · 9h55m home. The only nonstop home — no 5:30am connection in Port "
         "Moresby. On the snow two days earlier too"),
    ],
    "options_footnote":
        "There is no quick way <i>into</i> Sapporo: every routing checked today runs 21 hours or "
        "more, so the only leg you can genuinely speed up is the trip home — that's what the "
        "fastest row is buying. The Qantas QF107 Sydney–Sapporo nonstop priced today at "
        "<b>$1,730pp</b> all the way from Brisbane (QF501, 5:00am to Sydney, connecting to the "
        "9:05am departure), so <b>$2,640pp all-in ($10,560 for the four)</b> once the "
        "Sapporo→Tokyo hop and the flight home are added — roughly $1,150pp more than the "
        "cheapest, so it doesn't earn a row. No date shift saved $100pp or more: the wider "
        "windows (29 Jan–8 Feb out, 11–21 Feb back) turned up nothing below today's fares at "
        "all, so all three options stay put.",
    ...
    "itinerary": [
        ...
        ("Thu 4 Feb", "Tokyo → Sapporo", "7:15am hop up, land 9:05am, pick up the car; Snow Festival day 1 at Odori Park"),
        ("Fri 5 Feb", "Sapporo / Otaru", "Snow Festival day 2; evening in Otaru — canal illuminations and sushi"),
        ...
        ("Thu 11 Feb", "Rusutsu → Sapporo", "Drive back, Snow Festival closing day, drop the car at Sapporo (CTS)"),
        ("Fri 12 Feb", "Sapporo", "Spare Sapporo day — Nijo market, Mt Moiwa ropeway, night out in Susukino"),
        ("Sat 13 Feb", "Sapporo → Tokyo", "Fly 12:00pm → Haneda 1:40pm; afternoon in Shibuya"),
        ("Sun 14 Feb", "Tokyo", "Asakusa, Akihabara, teamLab Planets"),
        ("Mon 15 Feb", "Tokyo", "Day trip to Hakone — the droppable day if you'd rather ski again"),
    ...
    "itin_footnote":
        "<b>Best value</b> is the same trip on the ground — it just skips Port Moresby and the "
        "Narita overnight, landing you in Sapporo at 3:50pm on Wed 3 Feb, so you get a spare "
        "Sapporo afternoon before the festival opens. <b>Fastest sensible</b> shifts the whole "
        "thing two days earlier: on the snow Tue 2 Feb morning and home from Narita on Mon 15 "
        "Feb, which trims Tokyo to three days (Hakone dropped) but keeps all four ski days and "
        "both Snow Festival days.",
    "price_log_footnote":
        "Showing the last 10 checks; the chart above has all 34. Everything logged so far sits "
        "in the red HOLD band — the cheapest day yet was $1,333 on 31 Jul and 1 Aug.",
    "footer":
