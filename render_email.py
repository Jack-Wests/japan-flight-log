...
RUN = {
    "date_iso": "2026-09-21",
    "date_human": "Mon 21 Sep 2026",
    "verdict_headline": "🔴 HOLD — dear side, sit tight",
    "best_pp": "$1,674",
    "best_all4": "$6,697",
    "target_distance": "$244 above",
    "snapshot": [
        "The cheapest all-in way to get the four of you into the Hokkaido snow and home "
        "again is <b>$1,674 per person (~$6,697 for the four, ~$5,022 for three if Hugh sits "
        "it out)</b> — fly into Sapporo, do the trip, then home out of Tokyo. That's a "
        "<b>🔴 HOLD</b>: well above the $1,500 line, so today is a bad day to book.",
        "It's also a <b>jump up — $148 dearer than yesterday</b> ($1,526) and the "
        "<b>second-dearest reading in all 61 days of checks</b> (only 13 Sep's $1,709 beat it). "
        "This is the rising Snow Festival floor doing exactly what we expected as the cheap "
        "seats sell out — not a blip to chase.",
        "For a genuinely nicer trip it's worth knowing the <b>best-value option is just $21pp "
        "more ($1,695)</b>: one clean Cathay ticket into Sapporo on Wed 3 Feb, no overnight, "
        "no changing airports — versus the rock-bottom fare that lands you 5 Feb after an "
        "overnight airport-swap in Tokyo and eats a Snow Festival day.",
        "No verified airline sale is running today (the Qantas/Jetstar chatter online turned "
        "out to be old, expired posts — details in the nerd notes). Nothing to do: hold, and "
        "we've still got a few weeks before the mid-October book-anyway deadline.",
    ],
    "options": [
        ...
        ("Cheapest",
         ...
         "<i>(Jetstar direct)</i>, cross to Haneda + overnight, then 🛫 Dep Tokyo (HND) Fri 5 Feb "
         "6:45am → 🛬 lands Sapporo (CTS) Fri 5 Feb 8:20am <i>(Skymark)</i>",
         "🛫 Dep Tokyo (NRT) Tue 16 Feb 12:30pm → 🛬 lands Brisbane (BNE) Wed 17 Feb 8:00am "
         "<i>(via Seoul — Air Premia + Jetstar)</i>",
         "$1,674", "$6,697",
         "Long haul ~23h in incl. an overnight + Narita→Haneda swap; lands 5 Feb so you lose a festival day. False economy for $21pp"),
        ("Best value",
         "🛫 Dep Brisbane (BNE) Wed 3 Feb 12:50am → 🛬 lands Hong Kong (HKG) 7:20am, then "
         "🛫 Dep Hong Kong 12:20pm → 🛬 lands Sapporo (CTS) Wed 3 Feb 5:50pm <i>(one Cathay ticket)</i>",
         "🛫 Dep Tokyo (NRT) Tue 16 Feb 12:30pm → 🛬 lands Brisbane (BNE) Wed 17 Feb 8:00am "
         "<i>(via Seoul — Air Premia + Jetstar)</i>",
         "$1,695", "$6,780",
         "One clean ticket to the snow, no overnight; lands Wed 3 Feb for two full festival days. 18h in (5h Hong Kong layover, airside). The pick"),
        ("Fastest sensible",
         "🛫 Dep Brisbane (BNE) Tue 2 Feb 12:50am → 🛬 lands Hong Kong (HKG) 7:20am, then "
         "🛫 Dep Hong Kong 9:10am → 🛬 lands Sapporo (CTS) Tue 2 Feb 2:50pm <i>(Cathay)</i>",
         "🛫 Dep Tokyo (NRT) Thu 18 Feb 8:55pm → 🛬 lands Brisbane (BNE) Fri 19 Feb 6:50am "
         "<i>(Jetstar direct)</i>",
         "$1,895", "$7,579",
         "Quickest realistic: 15h in, 9h direct home. $221pp over the cheapest; home is an overnight red-eye landing 19 Feb"),
    ],
    "options_footnote":
        "The Qantas QF107 Sydney–Sapporo direct was priced as asked — <b>$1,787pp</b> for the "
        "flight in (Brisbane→Sydney→Sapporo on Qantas, lands the same day 5:55pm, ~14h, no "
        "overnight), which with the home leg and Sapporo hop comes to <b>~$2,649pp all-in "
        "(~$10,596 for four)</b>. It's the comfy one but ~$975pp dearer than the cheapest, so "
        "it doesn't get a live row. No date shift within ±3 days saved $100+ pp, so the dates stay put.",
    "itin_title": "Option A — Furano base (follows the Best-value flights)",
    "itin_subtitle": "13 nights · fly into Sapporo, home from Tokyo · hire car picked up &amp; dropped at Sapporo (CTS)",
    "itinerary": [
        ("Wed 3 Feb", "Brisbane → Sapporo", "Fly in via Hong Kong, land Sapporo (CTS) 5:50pm; pick up the hire car, check into Sapporo"),
        ("Thu 4 Feb", "Sapporo", "Snow Festival day 1 — Odori Park (festival's opening day)"),
        ("Fri 5 Feb", "Sapporo", "Snow Festival day 2; evening free in Susukino"),
        ("Sat 6 Feb", "→ Furano", "Drive ~2.5h to the Furano lodge, settle in, afternoon warm-up laps"),
        ("Sun 7 Feb", "Furano", "Ski day 1 — Isaac's AM beginner lesson, lads ride the powder"),
        ("Mon 8 Feb", "Furano", "Ski day 2 — Isaac's 2nd AM lesson, then all ski together"),
        ("Tue 9 Feb", "Furano / Biei", "Rest day — Biei & the Blue Pond, or chill at the lodge"),
        ("Wed 10 Feb", "Furano", "Ski day 3 — powder day"),
        ("Thu 11 Feb", "Furano / Asahikawa", "Rest day — Asahikawa Zoo penguin parade"),
        ("Fri 12 Feb", "Furano", "Ski day 4 — last big powder day"),
        ("Sat 13 Feb", "Furano → Sapporo", "Drive back: Jozankei day-use onsen soak, then Otaru Snow Light Path (its last evening); drop the car, night in Sapporo"),
        ("Sun 14 Feb", "Sapporo → Tokyo", "Fly Sapporo (CTS) 8:10am → Tokyo (HND) 9:55am; afternoon in Shibuya"),
        ("Mon 15 Feb", "Tokyo", "Asakusa, Akihabara, teamLab — last full day"),
        ("Tue 16 Feb", "Tokyo → home", "Fly home from Tokyo (NRT) 12:30pm"),
        ("Wed 17 Feb", "→ Brisbane", "Land Brisbane (BNE) 8:00am"),
    ],
    "itin_footnote":
        "All three options share this exact plan on the ground — only the flights in and out "
        "differ. <b>Cheapest</b> lands you in Sapporo on 5 Feb instead of 3 Feb, so you'd start "
        "at the Snow Festival a day or two late. <b>Fastest sensible</b> gets you in a day "
        "earlier (2 Feb) and flies you straight home from Tokyo, landing 19 Feb.",
    "price_log_footnote":
        "Showing the last 10 checks; the chart above has all 61. Today's $1,674 is the "
        "second-dearest we've logged — the cheapest day yet was $1,333 back on 31 Jul.",
    "footer":
