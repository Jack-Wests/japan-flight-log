...
RUN = {
    "date_iso": "2026-09-05",
    "date_human": "Sat 5 Sep 2026",
    "verdict_headline": "🔴 HOLD — dear side, sit tight",
    "best_pp": "$1,558",
    "best_all4": "$6,232",
    "target_distance": "$208 above",
    "snapshot": [
        "Cheapest way to get all four of you to the Hokkaido snow and home again today is "
        "<b>$1,558 per person — $6,232 for the four</b>, or <b>$4,674 for three</b> if Hugh "
        "can't make it. That's Singapore Airlines out to Sapporo (CTS) via Singapore and "
        "Osaka, a cheap Skymark hop down to Tokyo mid-trip, and Singapore Airlines home from "
        "Tokyo (HND). Every price on this page includes a 20kg checked bag each way and the "
        "Sapporo hop — no surprises bolted on later.",
        "Today is a <b>dear day, not a good one</b>: up <b>$95 on yesterday</b> ($1,463) and "
        "back above the $1,500 line. Across 46 days of checks this route has run between "
        "<b>$1,333 and $1,688</b>, so we're in the upper half but nowhere near the worst "
        "we've seen. Nothing here says book.",
        "The good news is you're not missing anything by waiting — yesterday's $1,463 shows "
        "the dips still come, and they've come roughly every few days all month. "
        "<b>Sit tight.</b>",
        "No verified airline sale is running. Jetstar's and Qantas's own deal pages were "
        "blocked to us again today, and every sale we could find in search results was "
        "months old — the Qantas Red Tail sale closed 4 August and the last Jetstar "
        "Return-for-Free was back in May. Nothing live that covers February 2027.",
    ],
    "options": [
        ...
        ("Cheapest",
         ...
         "$1,558", "$6,232", "$4,674",
         "Long haul: 21h over, 22h home. Home leg has 6½h at Changi — plenty for a wander "
         "round Jewel, not enough to bother going into town. Early 8:30am start on the last day"),
        ("Best value",
         "🛫 Dep Brisbane (BNE) Mon 1 Feb 6:10pm → 🛬 lands Sapporo (CTS) Tue 2 Feb 2:30pm "
         "<i>(same flight as cheapest)</i>",
         "🛫 Dep Tokyo (HND) Tue 16 Feb 4:40pm → 🛬 lands Brisbane (BNE) Wed 17 Feb 10:45am "
         "<i>(Singapore Airlines via Singapore)</i>",
         "$1,578", "$6,314", "$4,735",
         "Long haul: 21h over, but only 17h home instead of 22h — and a civilised afternoon "
         "flight out of Tokyo rather than a 5:30am wake-up. $20pp more"),
        ("Fastest sensible",
         ...
         "$1,742", "$6,967", "$5,225",
         "Quickest of the lot: 15h over, 11h home, no overnight anywhere. Downside is a "
         "12:50am departure from Brisbane and a 6:30am connection in Port Moresby. $184pp more"),
    ],
    "options_footnote":
        "The <b>Qantas QF107 Sydney–Sapporo direct</b> was priced again today: <b>$1,742pp</b> for "
        "that one flight, plus $132pp to get to Sydney, the Sapporo hop and the flight home — "
        "<b>$2,725pp all-in, $10,899 for four</b>. It's the nicest way to travel and roughly "
        "<i>double</i> the cheapest option, so it doesn't get a row. No date shift within ±3 days "
        "of our windows saved $100pp or more, so all three options stay put.",
    "itin_title": "Option A — Cheapest",
    "itin_subtitle": "Rusutsu base · 14 nights · hire car picked up &amp; dropped at Sapporo (CTS)",
    "itinerary": [
        ("Mon 1 Feb", "Brisbane → in the air", "Fly out Brisbane 6:10pm; overnight in the air via Singapore"),
        ("Tue 2 Feb", "→ Sapporo", "Land Sapporo 2:30pm, pick up the hire car, check in; night in Susukino"),
        ("Wed 3 Feb", "→ Rusutsu", "Drive ~2h to Rusutsu, check in, afternoon warm-up laps"),
        ("Thu 4 Feb", "Rusutsu", "Ski day 1 — Isaac AM lesson, lads ride powder"),
        ("Fri 5 Feb", "Rusutsu", "Ski day 2 — Isaac AM lesson, then all ride Mt Isola together"),
        ("Sat 6 Feb", "Rusutsu / Niseko", "Ski day 3 — day-trip to Niseko (45 min up the road)"),
        ("Sun 7 Feb", "Rusutsu", "Ski day 4 — tree runs, last big powder day"),
        ("Mon 8 Feb", "→ Sapporo", "Drive back to Sapporo; Snow Festival day 1 — Odori Park sculptures"),
        ("Tue 9 Feb", "Sapporo", "Snow Festival day 2 — Susukino ice sculptures + Tsudome site"),
        ("Wed 10 Feb", "Otaru", "Day trip to Otaru — canal illuminations and sushi in the evening"),
        ("Thu 11 Feb", "Sapporo", "Snow Festival last day; ramen alley, pack up"),
        ("Fri 12 Feb", "Sapporo → Tokyo", "Drop the car at Sapporo (CTS), fly 10:35am→12:20pm; afternoon in Shibuya"),
        ("Sat 13 Feb", "Tokyo", "Asakusa, Akihabara, teamLab Planets"),
        ("Sun 14 Feb", "Tokyo", "Hakone day trip — this is the droppable day if you'd rather ski another Rusutsu day"),
        ("Mon 15 Feb", "Tokyo", "Tsukiji breakfast, shopping, last night out"),
        ("Tue 16 Feb", "Tokyo → home", "Depart Haneda 8:30am — early start, sort the airport train the night before"),
        ("Wed 17 Feb", "→ Brisbane", "Land Brisbane 7:15am"),
    ],
    "itin_footnote":
        "<b>Best value</b> is exactly the same trip on the ground — it just flies home from Tokyo "
        "on the afternoon of Tue 16 Feb instead of first thing, landing Brisbane 10:45am on the "
        "Wednesday. <b>Fastest sensible</b> shifts everything a day later: out of Brisbane after "
        "midnight on Wed 3 Feb, Sapporo by 2:50pm the same day, and home from Tokyo on the night "
        "of Wed 17 Feb. Same 14 nights, same Rusutsu base, same Snow Festival days.",
    "price_log_footnote":
        "Showing the last 10 checks; the chart above has all 46. The cheapest day yet was $1,333 "
        "on 31 Jul and 1 Aug; the dearest was $1,688 on 10 Aug.",
    "footer":
        "Auto-sent daily flight watch · prices from Kiwi.com, AUD incl. 1 checked bag each way "
        "and the Sapporo hop · no verified sale live today.",
}
# ─────────────────────────────────────────────────────────────────────────────
...
assert not re.search(r"(?<![\d,])1,?200(?![\d,])", visible), \
...
text = build_text()
assert not re.search(r"(?<![\d,])1,?200(?![\d,])", text), "private buy target leaked into the text part"
