...
RUN = {
    "date_iso": "2026-09-07",
    "date_human": "Mon 7 Sep 2026",
    "verdict_headline": "🔴 HOLD — a normal price, just over the line",
    "best_pp": "$1,505",
    "best_all4": "$6,021",
    "target_distance": "$155 above",
    "snapshot": [
        "The cheapest sensible way to get all four of you to the Hokkaido snow and home "
        "again is <b>$1,505 per person (~$6,021 for the four, ~$4,516 for three)</b> — a "
        "Brisbane→Tokyo return through Nadi (Fiji) with a short hop up to Sapporo and back. "
        "That's a checked bag each way and the Sapporo hop already in the price.",
        "It tips <b>$5 over the $1,500 line</b>, so the light goes red — but be honest, "
        "$1,505 is a bang-average price for this route, not a dear one. It's up <b>$75 since "
        "the last check</b> (6 Sep, $1,430 — that was a good dip) and level with a week ago "
        "($1,499). Across all 48 checks the price has run <b>$1,333 to $1,688</b>, sitting "
        "around $1,490 most days. Don't book, don't panic — a dip like last week's will very "
        "likely come again.",
        "For <b>$110pp more ($1,615)</b> you can fly <b>straight into Sapporo</b> on Singapore "
        "Airlines and skip the Tokyo detour at the start — that's the one I'd actually book if "
        "you were booking today.",
        "No airline sale could be verified today — the Jetstar and OzBargain pages were both "
        "blocked, so nothing gets the action banner. Nothing to do today.",
    ],
    "options": [
        # (label, getting there, getting home, pp, all4, worth knowing)
        ("Cheapest",
         "🛫 Dep Brisbane (BNE) Tue 2 Feb 11:25am → 🛬 lands Tokyo (NRT) Wed 3 Feb 6:35am "
         "<i>(via Nadi, Fiji Airways)</i>, then hop up to Sapporo (CTS) the same day",
         "🛫 Hop Sapporo→Tokyo ~12 Feb, then Dep Tokyo (NRT) Wed 17 Feb 4:30pm → 🛬 lands "
         "Brisbane (BNE) Thu 18 Feb 10:15am <i>(via Nadi, Fiji Airways)</i>",
         "$1,505", "$6,021",
         "$4,516 for three. Cheapest all-in, but a Fiji red-eye each way and you land in Tokyo, not Sapporo"),
        ("Best value",
         "🛫 Dep Brisbane (BNE) Tue 2 Feb 6:10pm → 🛬 lands Sapporo (CTS) Wed 3 Feb 4:15pm "
         "<i>(via Singapore + Osaka, Singapore Airlines)</i> — straight to the snow",
         "🛫 Hop Sapporo→Tokyo ~12 Feb, then Dep Tokyo (NRT) Tue 16 Feb 10:00am → 🛬 lands "
         "Brisbane (BNE) Wed 17 Feb 7:15am <i>(via Singapore, Singapore Airlines)</i>",
         "$1,615", "$6,458",
         "$4,844 for three. Only $110pp more and you fly straight into Sapporo — the one I'd book"),
        ("Fastest sensible",
         "🛫 Dep Brisbane (BNE) Tue 2 Feb 12:50am → 🛬 lands Sapporo (CTS) Tue 2 Feb 2:50pm "
         "<i>(via Hong Kong, Cathay Pacific)</i> — single stop",
         "🛫 Hop Sapporo→Tokyo ~12 Feb, then Dep Tokyo (NRT) Wed 17 Feb 9:40pm → 🛬 lands "
         "Brisbane (BNE) Thu 18 Feb 9:40am <i>(via Port Moresby, Air Niugini)</i>",
         "$1,733", "$6,931",
         "$5,200 for three. Quickest both ways — 15h in, 11h home. $228pp more than cheapest"),
    ],
    "options_footnote":
        "The Qantas QF107 Sydney–Sapporo direct was priced again today — <b>$1,815pp all-in "
        "($7,260 for four)</b> with a Brisbane→Sydney hop added. It lands you at the snow the "
        "same afternoon (5:55pm) on one airline with bags through, but it's ~$310pp dearer than "
        "the cheapest, so it stays a footnote, not a row. No date shift within ±3 days saved "
    ...
    "itin_subtitle": "Rusutsu base · 14 nights · hire car picked up &amp; dropped at Sapporo (CTS). "
        "The other two options are the same trip on the ground.",
    "itinerary": [
        ("Tue 2 Feb", "Brisbane → Tokyo", "Fly out 11:25am via Nadi; overnight in the air"),
        ("Wed 3 Feb", "Tokyo → Sapporo", "Land Narita 6:35am, hop up to Sapporo (CTS), pick up the car; easy first night in Susukino"),
        ...
        ("Fri 12 Feb", "Sapporo → Tokyo", "Hop down to Tokyo; afternoon in Shibuya"),
        ("Sat 13 Feb", "Tokyo", "Asakusa, Akihabara, teamLab Planets"),
        ("Sun 14 Feb", "Tokyo", "Day trip to Hakone — the droppable day if you'd rather add a ski day"),
        ("Mon 15 Feb", "Tokyo", "Tsukiji breakfast, shopping"),
        ("Tue 16 Feb", "Tokyo", "Spare day — Shinjuku / Harajuku, last night out"),
        ("Wed 17 Feb", "Tokyo → home", "Depart Narita 4:30pm via Nadi"),
        ("Thu 18 Feb", "→ Brisbane", "Land Brisbane 10:15am"),
    ],
    "itin_footnote":
        "<b>Best value</b> is the same trip on the ground — it just flies straight into Sapporo "
        "on Singapore Airlines instead of landing in Tokyo first, and comes home a day earlier "
        "(16 Feb). <b>Fastest sensible</b> is also the same trip, flying in via Hong Kong (15h) "
        "and home via Port Moresby (11h) for the quickest door-to-door.",
    "price_log_footnote":
        "Showing the last 10 checks; the chart above has all 48. The cheapest day yet was "
        "$1,333 (31 Jul / 1 Aug); today's $1,505 sits right around the middle of the range.",
    "footer":
...
assert not re.search(r"(?<![\d,])(800|1200)(?![\d,])", visible), \
...
text = build_text()
assert not re.search(r"(?<![\d,])(800|1200)(?![\d,])", text), "private buy target leaked into the text part"
