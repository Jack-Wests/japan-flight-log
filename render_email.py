...
RUN = {
    "date_iso": "2026-08-31",
    "date_human": "Mon 31 Aug 2026",
    "verdict_headline": "\U0001F534 HOLD \u2014 still nowhere near a booking price",
    "best_pp": "$1,499",
    "best_all4": "$5,996",
    "target_distance": "$499 above",
    "snapshot": [
        "Cheapest all-in way to get the four of you to the Hokkaido snow and home again today is "
        "<b>$1,499 per person (~$5,996 for the four)</b> \u2014 Brisbane to Sapporo through Singapore and "
        "Osaka, a cheap hop down to Tokyo mid-trip, then home through Manila.",
        "That's <b>$17 cheaper than yesterday</b> ($1,516) and within $3 of where it sat a week ago "
        "($1,496). In other words: nothing has actually moved. Across 41 days of checks the price has "
        "run between <b>$1,333 and $1,688</b>, averaging about <b>$1,464</b>.",
        "Still a long way from the $1,000 buy target \u2014 <b>$499 above it</b> \u2014 so this is a "
        "🔴 HOLD. Nothing to do today.",
        "No airline sale could be verified: Jetstar, Qantas and Virgin's deal pages were all blocked "
        "outright by the network today, so treat any Japan sale you hear about as unconfirmed.",
    ],
    "options": [
        ("Cheapest",
         "\U0001F6EB Dep Brisbane (BNE) Mon 1 Feb 6:10pm \u2192 \U0001F6EC lands Sapporo (CTS) Tue 2 Feb 7:15pm "
         "<i>(Singapore Airlines via Singapore &amp; Osaka, then Skymark north)</i>",
         "\U0001F6EB Dep Tokyo (HND) Tue 16 Feb 3:25pm \u2192 \U0001F6EC lands Brisbane (BNE) Wed 17 Feb 10:15am "
         "<i>(Philippine Airlines via Manila)</i>",
         "$1,499", "$5,996",
         "Long haul: 26h over. The 8h gap in Osaka is enough to leave the airport \u2014 but you swap "
         "airports there (Kansai to Kobe by harbour ferry) with all the bags"),
        ("Best value",
         "\U0001F6EB Dep Brisbane (BNE) Mon 1 Feb 6:10pm \u2192 \U0001F6EC lands Sapporo (CTS) Tue 2 Feb 2:30pm "
         "<i>(Singapore Airlines via Singapore, then Peach from Osaka)</i>",
         "\U0001F6EB Dep Tokyo (HND) Tue 16 Feb 3:25pm \u2192 \U0001F6EC lands Brisbane (BNE) Wed 17 Feb 10:15am "
         "<i>(Philippine Airlines via Manila)</i>",
         "$1,536", "$6,144",
         "21h over, all through the one Osaka airport \u2014 no ferry, no bag reshuffle. Lands mid-"
         "afternoon with the day still usable. $37pp more"),
        ("Fastest sensible",
         "\U0001F6EB Dep Brisbane (BNE) Tue 2 Feb 6:10pm \u2192 \U0001F6EC lands Sapporo (CTS) Wed 3 Feb 4:15pm "
         "<i>(Singapore Airlines via Singapore &amp; Osaka)</i>",
         "\U0001F6EB Dep Tokyo (NRT) Wed 17 Feb 9:40pm \u2192 \U0001F6EC lands Brisbane (BNE) Thu 18 Feb 9:40am "
         "<i>(Air Niugini via Port Moresby)</i>",
         "$1,648", "$6,592",
         "Home in 11h instead of 18h \u2014 the shortest trip back that isn't silly money. $149pp more "
         "than the cheapest"),
    ],
    "options_footnote":
        "The Qantas QF107 Sydney\u2013Sapporo direct was priced again today: <b>$1,737pp</b> for the flight "
        "in, plus $137pp to get Brisbane\u2013Sydney the evening before (you'd overnight in Sydney \u2014 "
        "QF107 leaves at 9:05am and the morning Brisbane flight lands too late). All-in that trip is "
        "<b>$2,696pp ($10,784 for four)</b>. It's 8h50 gate to gate and lands you on the snow at 5:55pm the "
        "same day, but it's roughly $1,200pp more than the cheapest, so it doesn't get a row. "
        "No date shift beyond the search windows helps: leaving earlier than 1 Feb or coming home after "
        "18 Feb pushes the trip past 14 nights, so the saving isn't usable.",
    "itin_title": "Option A \u2014 Cheapest",
    "itin_subtitle": "Rusutsu base \u00b7 14 nights \u00b7 hire car picked up &amp; dropped at Sapporo (CTS)",
    "itinerary": [
        ("Mon 1 Feb", "Brisbane \u2192 in the air", "Fly out 6:10pm; connect in Singapore overnight"),
        ("Tue 2 Feb", "\u2192 Sapporo", "Through Osaka, land Sapporo (CTS) 7:15pm; pick up the car, into town"),
        ("Wed 3 Feb", "Sapporo", "Shake off the flight \u2014 Sapporo Beer Museum, dinner in Susukino"),
        ("Thu 4 Feb", "Sapporo", "Snow Festival day 1 \u2014 Odori Park, the big carvings"),
        ...
        ("Fri 12 Feb", "Sapporo \u2192 Tokyo", "Fly 11:35am \u2192 Haneda 1:20pm; afternoon in Shibuya"),
        ("Sat 13 Feb", "Tokyo", "Asakusa, Akihabara, teamLab Planets"),
        ("Sun 14 Feb", "Tokyo", "Day trip to Hakone \u2014 the droppable day if you'd rather ski one more"),
        ("Mon 15 Feb", "Tokyo", "Tsukiji breakfast, shopping, last night out"),
        ("Tue 16 Feb", "Tokyo \u2192 home", "Depart Haneda 3:25pm"),
        ("Wed 17 Feb", "\u2192 Brisbane", "Land Brisbane 10:15am"),
    ],
    "itin_footnote":
        "<b>Best value</b> is this exact trip, same days on the ground \u2014 it just flies straight through "
        "Osaka's one airport instead of crossing to Kobe by ferry, and lands in Sapporo at 2:30pm on the "
        "Tue instead of 7:15pm. <b>Fastest sensible</b> shifts everything one day later (out Tue 2 Feb, "
        "land Wed 3 Feb) and moves the Tokyo hop to the Sat 13 Feb evening flight, so Tokyo is Sun 14 to "
        "Wed 17 Feb and Hokkaido picks up the spare day \u2014 same 14 nights, same 4 ski days at Rusutsu, "
        "same two Snow Festival days.",
    "price_log_footnote":
        "Showing the last 10 checks; the chart above has all 41. Every day logged so far sits in the red "
        "HOLD band \u2014 the cheapest day yet was $1,333 back on 31 Jul, the dearest $1,688 on 10 Aug.",
    "footer":
