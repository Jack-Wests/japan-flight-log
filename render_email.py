...
RUN = {
    "date_iso": "2026-08-10",
    "date_human": "Mon 10 Aug 2026",
    "verdict_headline": "🔴 HOLD — the dearest day we've ever logged",
    "best_pp": "$1,688",
    "best_all4": "$6,754",
    "target_distance": "$688 above",
    "snapshot": [
        "The cheapest way to get all four of you to the Hokkaido snow and home again is "
        "<b>$1,688 per person (~$6,754 for the four)</b> — Jetstar to Tokyo, a night near "
        "Narita, a cheap hop up to Sapporo, the internal flight back down to Tokyo, then "
        "Air Niugini home through Port Moresby.",
        "That is <b>$301 dearer than yesterday</b> ($1,387) and a <b>new record high</b> "
        "across all 22 days we've been watching. The old worst was $1,592 back on 27 Jul; "
        "the best was $1,333 on 31 Jul.",
        "Nothing has changed about the trip itself. The flight out to Sapporo is roughly "
        "flat at ~$764pp — it's the way <i>home</i> that's gone up. The sub-$700 "
        "Tokyo→Brisbane seats we've been costing against for a fortnight simply aren't "
        "bookable this morning.",
        "No airline sale could be verified (the sale pages couldn't be reached at all "
        "today — details in the log). Nothing to do. A day like this is exactly when you "
        "<i>don't</i> book.",
    ],
    "options": [
        ...
        ("Cheapest",
         ...
         "<i>(Jetstar direct)</i>, sleep near the airport, then 🛫 Tokyo (NRT) Wed 3 Feb "
         "6:50am → 🛬 lands Sapporo (CTS) Wed 3 Feb 8:40am <i>(Peach)</i>",
         "🛫 Dep Tokyo (NRT) Wed 17 Feb 9:40pm → 🛬 lands Brisbane (BNE) Thu 18 Feb 9:40am "
         "<i>(Air Niugini via Port Moresby)</i>",
         "$1,688", "$6,754",
         "Long haul: 23h10m there — but the 12h stop is a real night in a Narita hotel bed, "
         "not a bench. Home is only 11h; the 60-min Port Moresby connection is tight"),
        ("Best value",
         "🛫 Dep Brisbane (BNE) Wed 3 Feb 11:40am → 🛬 lands Osaka (KIX) Wed 3 Feb 7:45pm "
         "<i>(Jetstar direct)</i>, night in Osaka, then 🛫 Osaka (KIX) Thu 4 Feb 9:35am → "
         "🛬 lands Sapporo (CTS) Thu 4 Feb 11:25am <i>(Japan Airlines)</i>",
         "🛫 Dep Tokyo (NRT) Wed 17 Feb 9:40pm → 🛬 lands Brisbane (BNE) Thu 18 Feb 9:40am "
         "<i>(Air Niugini via Port Moresby)</i>",
         "$1,754", "$7,016",
         "Long haul: 24h45m there — but 14h in Osaka is plenty to get into Namba for dinner "
         "and a proper sleep. $66pp turns the worst part of the trip into a night out"),
        ("Fastest sensible",
         "🛫 Dep Brisbane (BNE) Tue 2 Feb 11:10pm → 🛬 lands Sapporo (CTS) Wed 3 Feb 3:50pm "
         "<i>(China Airlines via Taipei &amp; Osaka, about 2h20 at each stop)</i>",
         "🛫 Dep Tokyo (NRT) Wed 17 Feb 9:40pm → 🛬 lands Brisbane (BNE) Thu 18 Feb 9:40am "
         "<i>(Air Niugini via Port Moresby)</i>",
         "$1,870", "$7,481",
         "17h40m there, under 20h and no overnight anywhere — full-service airline, red-eye "
         "out, on the snow the same afternoon. $182pp more than the cheapest"),
    ],
    "options_footnote":
        "The Qantas Sydney–Sapporo seasonal direct was priced again today, as always: "
        "<b>QF107 leaves Sydney (SYD) Wed 3 Feb 9:05am and lands Sapporo (CTS) 5:55pm the "
        "same day, $1,670pp</b>, plus $137pp Brisbane→Sydney the evening before and a Sydney "
        "airport hotel. All-in with the internal flight and the trip home that's "
        "<b>$2,732pp — $10,928 for the four</b>, about $1,044pp dearer than the cheapest, so "
        "it stays a footnote rather than a real pick. No date shift within ±3 days saved "
        "$100pp or more: 2 Feb was already the cheapest day out, and pushing the flight home "
        "to 18 Feb saved only about $10pp while adding a night.",
    "itin_title": "Option A — Cheapest",
    "itin_subtitle": "Rusutsu base · 14 nights · hire car picked up &amp; dropped at Sapporo (CTS)",
    "itinerary": [
        ("Tue 2 Feb", "Brisbane → Tokyo", "Fly out 10:30am, land Narita 6:25pm; hotel near the airport, early night"),
        ("Wed 3 Feb", "Tokyo → Sapporo", "6:50am hop to Sapporo (CTS), land 8:40am, pick up the car; Susukino for dinner"),
        ("Thu 4 Feb", "Sapporo", "Snow Festival day 1 — Odori Park, the big snow sculptures"),
        ...
        ("Tue 9 Feb", "Rusutsu / Niseko", "Ski day 3 — day-trip to Niseko (45 min drive)"),
        ("Wed 10 Feb", "Rusutsu", "Ski day 4 — tree runs, last big powder day"),
        ("Thu 11 Feb", "→ Sapporo", "Drive back via Lake Toya, drop the car at Sapporo (CTS); night out in Susukino"),
        ("Fri 12 Feb", "Sapporo", "Nijo market breakfast, Sapporo Beer Museum, Mt Moiwa night view"),
        ("Sat 13 Feb", "Sapporo → Tokyo", "Fly Sapporo (CTS) 12:00pm → Tokyo 1:50pm; afternoon in Shibuya"),
        ("Sun 14 Feb", "Tokyo", "Asakusa, Akihabara, teamLab Planets"),
        ("Mon 15 Feb", "Tokyo", "Day trip to Hakone — the droppable day if you'd rather add a Rusutsu ski"),
    ...
    "itin_footnote":
        "<b>Best value</b> and <b>Fastest sensible</b> are the same trip on the ground — only "
        "the way in changes. Best value starts a day later with a night in Osaka instead of "
        "Narita, so it's 13 nights and you'd drop the Hakone day. Fastest sensible lands you "
        "in Sapporo at 3:50pm on Wed 3 Feb with no overnight anywhere, and the plan runs "
        "exactly as above from day 2 onward.",
    "price_log_footnote":
        "Showing the last 10 checks; the chart above has all 22. Every day logged so far sits "
        "in the red HOLD band — the cheapest was $1,333 on 31 Jul, and today is the dearest yet.",
    "footer":
