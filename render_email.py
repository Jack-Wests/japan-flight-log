...
RUN = {
    "date_iso": "2026-09-02",
    "date_human": "Wed 2 Sep 2026",
    "verdict_headline": "🔴 HOLD — nothing worth booking today",
    "best_pp": "$1,458",
    "best_all4": "$5,830",
    "target_distance": "$458 above",
    "snapshot": [
        "The cheapest way to get all four of you to the Hokkaido snow and home again is "
        "<b>$1,458 per person — $5,830 for the four</b>, all-in with a 20kg checked bag each "
        "way and both Japanese domestic hops folded in.",
        "That's <b>$27 dearer than yesterday</b> and <b>$63 dearer than a week ago</b>, so "
        "nothing has moved in a direction that would make today a day to book. Across 43 days "
        "of checks the price has run between <b>$1,333 and $1,688</b>.",
        "The catch with the cheapest option is that it's genuinely rough: Air Niugini via Port "
        "Moresby, with a <b>20-hour overnight stuck inside Port Moresby airport</b> — not "
        "somewhere you can wander out of — then a second night near Tokyo before the hop up to "
        "Sapporo. About 42 hours from your front door to the snow.",
        "It also stretches the trip to 16 nights instead of the 13–14 you'd planned, because "
        "the cheap fare only lines up on 2 Feb out / 17 Feb back. Two extra nights of beds is "
        "maybe $70pp, which quietly eats half the $144pp gap to the Singapore Airlines option.",
        "No airline sale could be verified today — Jetstar, Qantas and Virgin's deal pages "
        "were all unreachable from here. Nothing time-sensitive; sit tight.",
    ],
    "options": [
        # (label, getting there, getting home, pp, all4, worth knowing)
        ("Cheapest",
         "🛫 Dep Brisbane (BNE) Tue 2 Feb 2:40pm → 🛬 lands Tokyo (NRT) Wed 3 Feb 8:00pm "
         "<i>(Air Niugini via Port Moresby)</i>, sleep near Haneda, then 🛫 Thu 4 Feb 6:50am "
         "→ 🛬 Sapporo (CTS) 8:20am",
         "🛫 Dep Sapporo (CTS) Fri 12 Feb 1:10pm → 🛬 Tokyo (HND) 2:55pm, then 🛫 Dep Tokyo "
         "(NRT) Wed 17 Feb 9:40pm → 🛬 lands Brisbane (BNE) Thu 18 Feb 9:40am",
         "$1,458", "$5,830",
         "Long haul: ~42h out — 20h locked in Port Moresby airport overnight, then a second "
         "night near Tokyo. Brutal"),
        ("Best value",
         "🛫 Dep Brisbane (BNE) Tue 2 Feb 6:10pm → 🛬 lands Sapporo (CTS) Wed 3 Feb 4:15pm "
         "<i>(Singapore Airlines via Singapore + Osaka)</i>",
         "🛫 Dep Sapporo (CTS) Fri 12 Feb 1:10pm → 🛬 Tokyo (HND) 2:55pm, then 🛫 Dep Tokyo "
         "(NRT) Tue 16 Feb 10:00am → 🛬 lands Brisbane (BNE) Wed 17 Feb 7:15am",
         "$1,602", "$6,410",
         "23h out, straight to the snow, no airport sleep. $144pp more — but two fewer nights "
         "of beds claws most of that back"),
        ("Fastest sensible",
         ...
         "(NRT) Wed 17 Feb 9:40pm → 🛬 lands Brisbane (BNE) Thu 18 Feb 9:40am",
         "$1,726", "$6,904",
         "15h out — half the travel time of the cheapest. Lands 2:50pm on day one, on the "
         "snow a day early"),
    ],
    "options_footnote":
        "The Qantas Sydney–Sapporo direct (QF107, Wed 3 Feb 9:05am → 5:55pm) prices at "
        "<b>$1,742pp</b> for that one leg, plus a $132pp Brisbane→Sydney hop the evening "
        "before and $735pp to get home from Tokyo — <b>$2,609pp all-in, $10,436 for the "
        "four</b>. That's roughly 1.8× the cheapest option, so it doesn't get a row. No date "
        "shift within ±3 days of the windows saved $100pp or more, so every option stays put.",
    "itin_title": "Option A — Cheapest",
    "itin_subtitle": "Rusutsu base · 16 nights · hire car picked up &amp; dropped at Sapporo (CTS)",
    "itinerary": [
        ("Tue 2 Feb", "Brisbane → Port Moresby", "Fly out 2:40pm, land Port Moresby 5:50pm; long night in the terminal"),
        ("Wed 3 Feb", "Port Moresby → Tokyo", "Fly 2:10pm, land Narita 8:00pm; bus across to a Haneda airport hotel"),
        ("Thu 4 Feb", "Tokyo → Sapporo", "Haneda 6:50am → Sapporo 8:20am, pick up the car; Snow Festival day 1 (Odori Park)"),
        ...
        ("Thu 11 Feb", "→ Sapporo", "Drive back, drop the car at Sapporo (CTS); Snow Festival final day, then Susukino"),
        ("Fri 12 Feb", "Sapporo → Tokyo", "Fly Sapporo 1:10pm → Haneda 2:55pm; afternoon in Shibuya"),
        ("Sat 13 Feb", "Tokyo", "Asakusa, Akihabara, teamLab Planets"),
        ("Sun 14 Feb", "Tokyo", "Day trip to Hakone — the droppable day if anyone wants more snow"),
        ("Mon 15 Feb", "Tokyo", "Tsukiji breakfast, shopping"),
        ("Tue 16 Feb", "Tokyo", "Shimokitazawa and Nakameguro, last night out"),
        ("Wed 17 Feb", "Tokyo → home", "Depart Narita 9:40pm"),
        ("Thu 18 Feb", "→ Brisbane", "Land Brisbane 9:40am"),
    ],
    "itin_footnote":
        "<b>Best value</b> is the same trip on the ground but two nights shorter and far less "
        "painful to get to: you land in Sapporo on the afternoon of Wed 3 Feb with no airport "
        "sleep, and come home on Tue 16 Feb. <b>Fastest sensible</b> puts you on the snow on "
        "Tue 2 Feb — a day earlier than everyone else — and cuts the trip out from 42 hours "
        "to 15.",
    "price_log_footnote":
        "Showing the last 10 checks; the chart above has all 43. Everything logged so far sits "
