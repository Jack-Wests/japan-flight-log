...
RUN = {
    ...
    "verdict_headline": "🔴 HOLD — one of the worst days we've logged",
    "best_pp": "$1,597",
    "best_all4": "$6,388",
    "target_distance": "$597 above",
    "snapshot": [
        "The cheapest way to get all four of you to the Hokkaido snow and home again today is "
        "<b>$1,597 per person — $6,388 for the four</b>, all-in with a 20kg checked bag each way "
        "and the Sapporo→Tokyo hop folded in.",
        "That is <b>$166 dearer than yesterday</b> ($1,431) and <b>$202 dearer than a week ago</b> "
        "($1,395). Out of 43 days of checks only four have ever been worse, so this is close to "
        "the top of the range, not the bottom. The log has run between <b>$1,333 and $1,688</b>.",
        "What moved is the long-haul legs, not the domestic ones: the cheap Port Moresby and "
        "Jetstar seats that carried the last few weeks aren't showing today, so the cheapest way "
        "in is now Singapore Airlines via Singapore and Osaka at <b>$745pp</b>, and the cheapest "
        "way home is Singapore Airlines out of Tokyo at <b>$735pp</b>.",
        "No airline sale could be verified — Jetstar, Qantas and Virgin's deal pages were all "
        "unreachable from here again, so nothing is reported as live.",
        "Nothing to do. This is a day to sit on your hands; the log says prices like this come "
        "back down within a week or two.",
    ],
    "options": [
        ...
        ("Cheapest",
         ...
         "<i>(Singapore Airlines via Singapore, then Osaka on Peach)</i>",
         ...
         "$1,597", "$6,388",
         "23h out, 20h home — but no airport sleeps, and 5¾h at Osaka Kansai is long enough to "
         "leave the terminal and get a feed"),
        ("Best value",
         ...
         "<i>(Singapore Airlines via Singapore)</i>",
         "$1,687", "$6,746",
         "15h out instead of 23h for $90pp more — lands 2:50pm on day one, on the snow the same "
         "day. The 12:50am departure is the catch"),
        ("Fastest sensible",
         "🛫 Dep Brisbane (BNE) Tue 2 Feb 12:50am → 🛬 lands Sapporo (CTS) Tue 2 Feb 2:50pm "
         "<i>(Cathay Pacific via Hong Kong)</i>",
         "🛫 Dep Sapporo (CTS) Fri 12 Feb 1:10pm → 🛬 Tokyo (HND) 2:55pm, then 🛫 Dep Tokyo "
         "(NRT) Wed 17 Feb 8:55pm → 🛬 lands Brisbane (BNE) Thu 18 Feb 6:50am "
         "<i>(Jetstar direct)</i>",
         "$1,849", "$7,395",
         "15h out, 9h home — the quickest door-to-door on offer, but $252pp over the cheapest"),
    ],
    "options_footnote":
        "The Qantas Sydney–Sapporo direct (QF107, Wed 3 Feb 9:05am → 5:55pm) prices at "
        "<b>$1,742pp</b> for that leg alone, plus a $132pp Brisbane→Sydney hop the evening "
        "before, the $117pp Sapporo→Tokyo hop and $735pp to get home — <b>$2,726pp all-in, "
        "$10,904 for the four</b>. That's about 1.7× the cheapest option, so it doesn't get a "
        "row. Flying out a day early on Mon 1 Feb saves only $39pp, and nothing in the three "
        "days either side of the home window beats Tue 16 Feb at all, so no date shift clears "
        "the $100pp bar and every option stays put.",
    "itin_title": "Option A — Cheapest",
    "itin_subtitle": "Rusutsu base · 13 nights · hire car picked up &amp; dropped at Sapporo (CTS)",
    "itinerary": [
        ("Tue 2 Feb", "Brisbane → in the air", "Fly out 6:10pm; overnight flight, quick change in Singapore"),
        ("Wed 3 Feb", "Osaka → Sapporo", "5¾h at Osaka Kansai, then land Sapporo (CTS) 4:15pm; pick up the car, into town"),
        ...
        ("Thu 11 Feb", "→ Sapporo", "Drive back to Sapporo; Snow Festival final day, then a night in Susukino"),
        ("Fri 12 Feb", "Sapporo → Tokyo", "Drop the car at Sapporo (CTS), fly 1:10pm → Tokyo (HND) 2:55pm; afternoon in Shibuya"),
    ...
    "itin_footnote":
        "<b>Best value</b> is the same trip on the ground — it just flies Cathay through Hong "
        "Kong and gets you onto the snow on Tue 2 Feb, a day earlier, for $90pp more. "
        "<b>Fastest sensible</b> is that same trip out, then Jetstar straight home from Tokyo on "
        "Wed 17 Feb, turning a 20-hour trip back into about 9 hours.",
    "price_log_footnote":
